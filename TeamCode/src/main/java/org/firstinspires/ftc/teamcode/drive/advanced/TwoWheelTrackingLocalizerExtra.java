 ...
 *
 */
public class TwoWheelTrackingLocalizerExtra extends TwoTrackingWheelLocalizer {
    ...
    public TwoWheelTrackingLocalizerExtra(HardwareMap hardwareMap, SampleMecanumDriveCancelable drive) {
        super(Arrays.asList(
